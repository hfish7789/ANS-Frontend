...
import settingIcon from '../../assets/arcticons_settings.png'
          ...
          <>
            <DetailsKey>
              <Stack direction='row' alignItems='center' spacing={2}>
                {keyName === 'registrant' && <Typography component='img' src={registIcon} />}
                {keyName === 'Controller' && <Typography component='img' src={controlIcon} />}
                {keyName === 'Expiration Date' && <Typography component='img' src={dateIcon} />}
                {keyName === 'Resolver' && <Typography component='img' src={settingIcon} />}
                <Typography sx={{ fontWeight: "700" }}>{t(`c.${keyName}`)}</Typography>
              </Stack>
            </DetailsKey>
            <DetailsValue
              editing={editing}
