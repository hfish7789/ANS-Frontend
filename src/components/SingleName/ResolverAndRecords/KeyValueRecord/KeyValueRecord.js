...
import parent2Icon from '../../../../assets/akar-icons_link-chain-1.png'
import recordIcon from '../../../../assets/carbon_text-creation.png'
import {
  Stack,
  Typography,
} from '@mui/material'
    ...
    <KeyValueContainer hasRecord={hasRecord}>
      <Key>
        <Stack direction='row' alignItems='center' spacing={2}>
          {title === 'parent' && <Typography component='img' src={parent2Icon} />}
          {title === 'Text Record' && <Typography component='img' src={recordIcon} />}
